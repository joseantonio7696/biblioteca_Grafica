...
public class Formulario extends JFrame {
	...
	private void definirVentana(List<Libro> listadoLibros) {
		...
		//NOS CREAMOS UN ARRAY UNIDIMENSIONAL PARA METER LOS PRIMEROS VALORES DEL ARRAY LIST AL CARGAR EL FORMULARIO
		String libros [] = listadoLibros.get(0).toString().split(",");
		...
		//PARA EL CHECKBOX TENDREMOS QUE COMPROBAR SI EL ATRIBUTO BOOLEANO ESTA TRUE O FALSE Y SEGUIDAMENTE LE MANDAMOS LA VARIABLE ACTIVADO SEGUN EL VALOR DE EL VALOR DE DICHO ARRAYLIST
		...
		panel_3 = new JPanel();
		panel_3.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 255), 2), "Navegador", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
